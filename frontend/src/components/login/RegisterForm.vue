<template>
    <el-row class="container">
        <el-col :lg="10" :md="12" :xs="18" :span="12">
            <div class="main">
                <el-row>
                    <el-button type="primary" circle icon="el-icon-back" @click="back" class="back" size="mini"></el-button>
                    <p class="info">注 册</p>
                </el-row>
                ...
                <el-form ref="form" :model="form" label-width="80px">
                    ...
                    <el-form-item label="身份" size="medium">
                        <el-select v-model="form.role" placeholder="请选择您的身份" class="role">
                            <el-option 
                    ...
                    <el-row class="register-button">
                        <el-button type="primary" size="medium" @click="register" class="button">注册</el-button>  
                    </el-row>
                </el-form>
            </div>
        </el-col>
            ...
            axios({
                ...
                if(error.response) {
                    if (username === '') {
                        ...
                        this.$message({
                            showClose:true,
                            message:'用户名要以英文字母开头，并只能含有英文字母或阿拉伯数字',
                            type:'error'
                        })
                        return
                    }else if (password === '') {
